    ...
    return (
        <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative'>
            ...
            <div className="w-full py-16 flex gap-8">
                <div className="w-2/3">
                    <p className="text-lg">
                    At [Your Business Name], we understand the high cost of maintaining a fleet of trucks firsthand. While managing a logistics company and running a fleet, we saw the constant demand for quality truck parts. Too often, businesses face the difficult choice between expensive new parts or unreliable, low-grade aftermarket options. That’s why we created [Your Business Name] – to offer a better, more affordable solution.
                    <br></br>
                    <br />
